        ...
        Data::Config((name, value)) => match value {
            None => {
                ...
                if name == "id" {
                    ...
                    // Restore the "hide connection management window" option for everyone.
                    // Upstream removed the UI toggle for all builds, so this returns the
                    // value unconditionally and the re-enabled toggle works again.
